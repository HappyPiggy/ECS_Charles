...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.PrimaryEntityIndex<GameEntity, ulong>(
            ...
            (e, c) => ((UIDComponent)c).value));
    }
}

public static class ContextsExtensions {

    public static GameEntity GetEntityWithUID(this GameContext context, ulong value) {
        return ((Entitas.PrimaryEntityIndex<GameEntity, ulong>)context.GetEntityIndex(Contexts.UID)).GetEntity(value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
